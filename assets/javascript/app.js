...
var trivia = {
   ...
   questions: {
    ...
    q3: 'In S2E8 "Performance Review" Who does Michael quickly dismiss saying "You were totally satisfactory this year"?',
   ...
   options: {
       q1: ['Thats what she said' , 'Bears Beats Battlestar Galactica', 'Question' , 'Did I Stutter?'],
       q2: ['Dave', 'Bookface', 'Three Hole Punch Jim', 'Rational Consumer'],
       q3: ['Oscar', 'Angela', 'Kevin', 'Dwight'],
       q4: ['He gets his head stuck in a stair railing', 'He crashes his car into a telephone pole', 'He is run over by a co-worker', 'He burns his foot on a George Foreman Grill'],
       q5: ['Angela', 'Dwight', 'Kevin', 'Michael'],
       q6: ['Lovefool by The Cardigans', 'Kiss Me by Six Pence None the Richer','Barbie Girl by Agua', 'Macarena by Los Del Rio'],
       q7: ['Dwight', 'Angela', 'Michael', 'Jim'],
       q8: ['A backwards golf cap', 'A bandana', 'A sumo suit', 'A sequined glove'],
       q9: ['Meredith', 'Creed', 'Pam', 'Phillis'],
       q10: ['Drinks at Poor Richards', 'Listened to Zepplin in Merediths van', 'Dance Party', 'Lunch at Pizza by Alfredos ' ],
   },
   answers: {
